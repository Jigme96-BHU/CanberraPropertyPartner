    ...
    <>
      ...
      <section style={{ position:'relative', padding:'160px 0', background:'#0A0A0A', overflow:'hidden', textAlign:'center' }}>
        ...
        <div className="container" style={{ position:'relative', zIndex:2, maxWidth:'700px', margin:'0 auto' }}>
          ...
          {/* Tenant maintenance callout */}
          <div style={{ marginTop:'48px', paddingTop:'48px', borderTop:'1px solid rgba(255,255,255,0.08)' }}>
            <p style={{ fontSize:'13px', color:'rgba(255,255,255,0.35)', letterSpacing:'0.1em', marginBottom:'16px' }}>CURRENT TENANTS</p>
            <p style={{ fontSize:'16px', color:'rgba(255,255,255,0.55)', marginBottom:'20px' }}>
              Experiencing a maintenance issue at your property? Our AI assistant can help you troubleshoot common problems anytime.
            </p>
            <a
